module github.com/anyproto/any-sync-sdk

go 1.25.7

require (
	github.com/anyproto/any-store v0.4.7-0.20260317134908-7a1c24d50544
	github.com/anyproto/any-sync v0.11.22-0.20260331151810-c8cd6dda8362
