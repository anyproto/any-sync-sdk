...
const (
	...
	// P2PStateNotPossible — p2p is disabled in config, the device has
	// no usable network interface, or local discovery is switched off
	// with no LAN peer known and no global layer to find one.
	P2PStateNotPossible
