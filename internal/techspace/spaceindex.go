...
func SpaceIndexSchema() schema.Dataset {
	...
	return schema.Dataset{Fields: []schema.Field{
		...
		{Id: FieldAdvertise, Name: "P2P advertise", Schema: schema.Leaf(schema.KindBoolean), Scope: schema.ScopeSynced},
...
const (
	...
	// FieldAdvertise (synced, account-wide) is the per-space p2p
